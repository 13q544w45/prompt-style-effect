...
def generate_closedbookqa_basic():
    few_shot_path = "prompts/closedbookqa_basic.txt"
    test_data_path = "data/sample_dataset/qa_100.jsonl"
    output_path = "data/generated_prompts/closedbookqa_basic_prompts.jsonl"
    ...
    for i, sample in enumerate(test_samples):
        ...
        prompt_text = build_prompt(few_shot_prefix, question)
        results.append({
            "id": i,
            "prompt": prompt_text,
            "answer": answer
