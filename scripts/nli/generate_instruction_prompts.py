...
def generate_prompts():
    few_shot_prefix = load_few_shot_examples("prompts/nli_instruction.txt")
    samples = load_samples("data/sample_dataset/nli_100.jsonl")
    results = []
    ...
    output_path = "data/generated_prompts/nli_instruction_prompts.jsonl"
