...
INPUT_FILE = "data/model_inputs/nli_cot_cleaned.jsonl"
OUTPUT_FILE = "data/model_outputs/nli_cot_gpt3.jsonl"
    ...
    try:
        response = openai.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": f"{prompt}\nPlease think step by step and finish your answer with 'The answer is ...'"
                }
            ],
            temperature=0.0,
