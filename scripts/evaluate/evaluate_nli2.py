...
def evaluate_predictions(truth_path, prediction_path, output_path):
    ...
    for i in range(total):
        ...
        gt_answer = normalize(gt_data[i]["label"])
        raw_output = pred_data[i]["gpt3_label"]
...
def main():
    ...
    prediction_path = "data/model_outputs/nli_cot_gpt3.jsonl"
    output_path = "evaluation/nli_cot.jsonl"
